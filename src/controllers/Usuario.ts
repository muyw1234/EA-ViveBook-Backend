...
export default { createUsuario, getUsuario, getFollowers, getAllUsuarios, getAllUsuarios_NOT_Deleted, updateUsuario, deleteUsuario, permanentDeleteUsuario, restoreUsuario, searchUsuarioByName, toggleWishlist, toggleFavorite };
